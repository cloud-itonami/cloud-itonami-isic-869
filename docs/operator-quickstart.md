# Operator Quickstart — Other Human Health Activities - Non-Emergency Transport Coordination

Shortest path from clone to a verified local dry-run for **ISIC 869** (`cloud-itonami-isic-869`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-869.git
cd cloud-itonami-isic-869
```
...
- Blueprint governor key: `transport-governor`
- Likely source path: `transportops.governor.cljc`
